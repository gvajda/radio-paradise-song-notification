...
namespace Foobar2000.RESTClient.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(string pathSeparator = default(string), List<FileSystemEntry> roots = default(List<FileSystemEntry>))
        {
        ...
        public List<FileSystemEntry> Roots { get; set; }
