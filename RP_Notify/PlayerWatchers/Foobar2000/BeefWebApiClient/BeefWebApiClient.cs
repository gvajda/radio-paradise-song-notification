...
// <auto-generated>
//     Generated using the NSwag toolchain v13.18.2.0 
// </auto-generated>
//----------------------
...
namespace RP_Notify.PlayerWatchers.Foobar2000.BeefWebApiClient
{
    ...
    public partial class BeefWebApiClient : IBeefWebApiClient
    {
        private string _baseUrl = "http://localhost:8880/api";
        private readonly IHttpClientFactory _httpClientFactory;
        private System.Lazy<JsonSerializerOptions> _settings;

        public BeefWebApiClient(IHttpClientFactory httpClientFactory)
        {
        ...
        protected virtual async System.Threading.Tasks.Task<ObjectResponseResult<T>> ReadObjectResponseAsync<T>(System.Net.Http.HttpResponseMessage response, System.Collections.Generic.IReadOnlyDictionary<string, System.Collections.Generic.IEnumerable<string>> headers, System.Threading.CancellationToken cancellationToken)
        {
            ...
            else
            {
                try
                {
                    ...
                    var typedBody = JsonSerializer.Deserialize<T>(responseBytes);
